// C++ program to delete a node in singly linked list recursively
#include <bits/stdc++.h>
using namespace std;
...
// Deletes the node containing 'info part as val and alter the head of
...
// Here we are passing head by reference thus no need to
